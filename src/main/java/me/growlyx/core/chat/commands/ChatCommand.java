        ...
        if (sender instanceof Player) {
            ...
            if (args.length == 0) {
                ...
                if (!chatEnabled) {
                    ...
                    chatEnabled = true;
                    sender.sendMessage(CC.translate(Messages.string("FORMAT.PREFIX") + Messages.string("MESSAGES.CHAT.MUTE").replace("<user>", player.getDisplayName())));
                    ...
                    chatEnabled = false;
                    sender.sendMessage(CC.translate(Messages.string("FORMAT.PREFIX") + Messages.string("MESSAGES.CHAT.UNMUTE").replace("<user>", player.getDisplayName())));
