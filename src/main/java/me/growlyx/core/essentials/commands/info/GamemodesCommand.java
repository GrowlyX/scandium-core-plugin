...
@Commands(@org.bukkit.plugin.java.annotation.command.Command(name = "gamemodes"))
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            if (args.length == 0) {
                ...
                if (Messages.aboolean("MESSAGES.INFO.GAMEMODES.ENABLED")) {

                    for (String string: Core.instance.m.getConfig().getStringList("MESSAGES.INFO.GAMEMODES.MESSAGE")) {
