...
@Commands(@org.bukkit.plugin.java.annotation.command.Command(name = "forums"))
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            if (args.length == 0) {
                ...
                if (Messages.aboolean("MESSAGES.INFO.FORUMS.ENABLED")) {

                    for (String string: Core.instance.m.getConfig().getStringList("MESSAGES.INFO.FORUMS.MESSAGE")) {
