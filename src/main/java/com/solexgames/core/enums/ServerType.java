...
public enum ServerType {
    ...
    SCANDIUM("Scandium", "04", ChatColor.GOLD, ChatColor.YELLOW, "", "https://solexgames.com", "SolexDev", "store.solexgames.com", "solexgames.com", UUID.fromString("c9647f7a-abfb-41c4-a8ce-a07d74434ca6"), UUID.fromString("bbaa8e1d-af94-4aa8-980d-36d69b9de436")),
