...
public class NMSAccess_v1_9 implements INMS {
    ...
    public void updatePlayer(Player player) {
        final net.minecraft.server.v1_9_R2.EntityPlayer entityPlayer = ((org.bukkit.craftbukkit.v1_9_R2.entity.CraftPlayer) player).getHandle();
        final Location previousLocation = player.getLocation().clone();

        entityPlayer.playerConnection.sendPacket(new net.minecraft.server.v1_9_R2.PacketPlayOutPlayerInfo(net.minecraft.server.v1_9_R2.PacketPlayOutPlayerInfo.EnumPlayerInfoAction.REMOVE_PLAYER, entityPlayer));
        entityPlayer.playerConnection.sendPacket(new net.minecraft.server.v1_9_R2.PacketPlayOutPlayerInfo(net.minecraft.server.v1_9_R2.PacketPlayOutPlayerInfo.EnumPlayerInfoAction.ADD_PLAYER, entityPlayer));
        entityPlayer.playerConnection.sendPacket(new net.minecraft.server.v1_9_R2.PacketPlayOutRespawn(
                ...
                net.minecraft.server.v1_9_R2.WorldSettings.EnumGamemode.valueOf(entityPlayer.getBukkitEntity().getGameMode().name())
        ));
    ...
    public void updateCache(Player player) {
        final List<net.minecraft.server.v1_9_R2.EntityPlayer> playerList = new ArrayList<>(net.minecraft.server.v1_9_R2.MinecraftServer.getServer().getPlayerList().players);
        final net.minecraft.server.v1_9_R2.EntityPlayer entityPlayer = playerList.stream()
                .filter(entityPlayer1 -> entityPlayer1.getUniqueID().equals(player.getUniqueId()))
                .findFirst().orElse(null);

        playerList.remove(entityPlayer);
        playerList.add(((org.bukkit.craftbukkit.v1_9_R2.entity.CraftPlayer) player).getHandle());

        try {
            final Object list = net.minecraft.server.v1_9_R2.MinecraftServer.getServer().getPlayerList().getClass()
                    .getMethod("playerList", ((Class<?>[]) null))
                    .invoke(net.minecraft.server.v1_9_R2.MinecraftServer.getServer().getPlayerList());
