...
public class NMSAccess_v1_12 implements INMS {
    ...
    public void updateCache(Player player) {
        final List<net.minecraft.server.v1_12_R1.EntityPlayer> playerList = new ArrayList<>(net.minecraft.server.v1_12_R1.MinecraftServer.getServer().getPlayerList().players);
        final net.minecraft.server.v1_12_R1.EntityPlayer entityPlayer = playerList.stream()
                .filter(entityPlayer1 -> entityPlayer1.getUniqueID().equals(player.getUniqueId()))
                .findFirst().orElse(null);

        playerList.remove(entityPlayer);
        playerList.add(((org.bukkit.craftbukkit.v1_12_R1.entity.CraftPlayer) player).getHandle());

        try {
            final Object list = net.minecraft.server.v1_12_R1.MinecraftServer.getServer().getPlayerList().getClass()
                    .getMethod("playerList", ((Class<?>[]) null))
                    .invoke(net.minecraft.server.v1_12_R1.MinecraftServer.getServer().getPlayerList());
