...
public class RankSuffixPrompt extends StringPrompt {
    ...
    public String getPromptText(ConversationContext conversationContext) {
        return Color.SECONDARY_COLOR + "Please enter the rank suffix you want to set. " + ChatColor.GRAY + "(Or, type 'cancel' to cancel)";
    }
    ...
    public Prompt acceptInput(ConversationContext conversationContext, String s) {
        ...
        this.rank.setSuffix(prefix);

        conversationContext.getForWhom().sendRawMessage(Color.SECONDARY_COLOR + "You've set the suffix to: " + prefix);
