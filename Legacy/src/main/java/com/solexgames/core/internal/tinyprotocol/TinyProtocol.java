package com.solexgames.core.internal.tinyprotocol;
...
import com.solexgames.core.internal.tinyprotocol.Reflection.FieldAccessor;
import com.solexgames.core.internal.tinyprotocol.Reflection.MethodInvoker;
...
public abstract class TinyProtocol {
	...
	public static final MethodInvoker getProfile = Reflection.getMethod("{obc}.entity.CraftPlayer", "getProfile");
	...
	private static final FieldAccessor<Integer> protocolId = Reflection.getField(TinyProtocol.PACKET_SET_PROTOCOL, Integer.TYPE, 0);
	...
	private static final FieldAccessor<Enum> protocolType = Reflection.getField(TinyProtocol.PACKET_SET_PROTOCOL, Enum.class, 0);
	...
	private void registerBukkitEvents() {
		listener = new Listener() {
			...
			public final void onPlayerLogin(PlayerLoginEvent e) {
				if (closed)
					return;
				//annoying error if player logs in too fast
				try {
	...
	public int getProtocolVersion(Player player) {
		...
		if (channel == null) {
			Object connection = TinyProtocol.getConnection.get(TinyProtocol.getPlayerHandle.invoke(player, new Object[0]));
	...
	private final class PacketInterceptor extends ChannelDuplexHandler {
		...
		private void handleLoginStart(Channel channel, Object packet) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
			...
			} else if (OutlastTab.getInstance().getPlayerVersion().getClass() == PlayerVersionTinyProtocol.class && TinyProtocol.PACKET_SET_PROTOCOL.isInstance(packet)) {
				Method method = packet.getClass().getMethod("b");
				protocolLookup.put(channel, (int) method.invoke(packet));
			}
		}
	}
}
